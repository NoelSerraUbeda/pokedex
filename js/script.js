document.addEventListener('DOMContentLoaded', () => {
    ...
    const generation_filter_buttons = document.getElementById('generation-buttons');
    ...
    const typeImages = {
        fire: 'resources/images/types/fire.webp',
        grass: 'resources/images/types/grass.webp',
        electric: 'resources/images/types/electric.webp',
        water: 'resources/images/types/water.webp',
        ground: 'resources/images/types/ground.webp',
        rock: 'resources/images/types/rock.webp',
        fairy: 'resources/images/types/fairy.webp',
        poison: 'resources/images/types/poison.webp',
        bug: 'resources/images/types/bug.webp',
        dragon: 'resources/images/types/dragon.webp',
        psychic: 'resources/images/types/psychic.webp',
        flying: 'resources/images/types/flying.webp',
        fighting: 'resources/images/types/fighting.webp',
        normal: './resources/images/types/normal.webp',
        dark: 'resources/images/types/dark.webp',
        steel: 'resources/images/types/steel.webp',
        ice: 'resources/images/types/ice.webp',
        ghost: 'resources/images/types/ghost.webp'
    };
    ...
    const createPokemonCard = async (pokemon) => {
        ...
        pokemonEl.addEventListener('click', () => {
            alert(`This Pokémon belongs to Generation ${getGeneration(pokemon.id)}.`);
        });
